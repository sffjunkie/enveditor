# -*- coding: utf-8 -*-
#
# Ask Me Anything documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath(os.path.join('..', 'enveditor')))
#print(sys.path)
...
project = u'Environment Editor'
copyright = u'2018, Simon Kennedy'
...
htmlhelp_basename = 'AskMeAnythingdoc'
...
latex_documents = [
  ('index', 'enveditor.tex', u'Environment Editor Documentation',
...
man_pages = [
    ('index', 'enveditor', u'Ask Me Anything Documentation',
     [u'Simon Kennedy'], 1)
]
...
texinfo_documents = [
  ('index', 'AskMeAnything', u'Ask Me Anything Documentation',
   u'Simon Kennedy', 'AskMeAnything', 'One line description of project.',
   'Miscellaneous'),
]
